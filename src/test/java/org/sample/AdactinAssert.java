...
public class AdactinAssert  extends BaseParent {
	...
	public void tc1() throws Exception {
		...
		Assert.assertEquals("ArshiYas",user,"user name verification");
		
		toInput(a.getTxtPass(), toReadCell("AdactinTC", "Sheet1", 1, 1));
		String pass = toGetAttribute(a.getTxtPass());
		SoftAssert s=new SoftAssert();
		s.assertEquals("hello@12",pass,"user password verification");                   //fails
		...
		String firstnm = toGetAttribute(d.getFirst());
		s.assertTrue(firstnm.contains("Arshida"),"1st name verification");
				
		toInput(d.getLast(),toReadCell("AdactinTC", "Sheet1", 5, 1));
		String lastnm = toGetAttribute(d.getLast());
		s.assertTrue(lastnm.contains("Arif"),"last name verification");
